...
class AppLocale {
  ...
  static const Map<String, String> _en = {
    ...
    'Réessayer': 'Try again',
    'Vous pouvez ajuster votre prix ci-dessous, ou la retrouver dans Mes offres.': 'You can adjust your price below, or find it in My offers.',
    'Mettre à jour mon offre': 'Update my offer',
    'Offre mise à jour': 'Offer updated',
    'Continuer la course': 'Continue the ride',
    'Terminer la course ?': 'End the ride?',
    'Confirmez uniquement lorsque le passager est arrivé à destination.': 'Confirm only once the passenger has arrived at their destination.',
    'Restauration de votre session…': 'Restoring your session…',
    'Connexion impossible': 'Could not connect',
    'Votre session est conservée.': 'Your session has been kept.',
    'Filtres': 'Filters',
    ...
    'ETA : ': 'ETA: ',
    'Vers le client': 'To customer',
    'Client pris en charge': 'Customer picked up',
    ...
    'Clôturée': 'Closed',
    'Annulée': 'Cancelled',
    'Annulée par le chauffeur': 'Cancelled by driver',
    'Client absent': 'Customer no-show',
    'Date': 'Date',
    'Plus proches': 'Soonest',
  };
}
