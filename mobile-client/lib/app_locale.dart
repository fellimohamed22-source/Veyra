...
class AppLocale {
  ...
  static const Map<String, String> _en = {
    ...
    'Vos trajets VTC, réservés à l’avance.': 'Your VTC trips, booked in advance.',
    'Réservation planifiée': 'Scheduled booking',
    'Planifiez votre prochain trajet': 'Plan your next trip',
    'Choisissez le trajet, la date et l’heure. Départ au minimum 2 h à l’avance.': 'Choose the route, date and time. Departure must be at least 2 hours ahead.',
    'Mes trajets planifiés': 'My scheduled trips',
    'Veyra MVP fonctionne uniquement sur réservation planifiée, au minimum 2 h avant le départ.': 'Veyra MVP only supports scheduled bookings, at least 2 hours before departure.',
    'Comparer les offres': 'Compare offers',
    'Voir les détails': 'View details',
    'Choisir votre chauffeur': 'Choose your driver',
    '1 offre reçue': '1 offer received',
    'offres reçues': 'offers received',
    'Comparez librement le prix, le véhicule et le chauffeur.': 'Freely compare price, vehicle and driver.',
    'Chauffeur Veyra vérifié': 'Verified Veyra driver',
