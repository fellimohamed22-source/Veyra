...
class AppLocale {
  ...
  static const Map<String, String> _en = {
    ...
    'En attente d’offres': 'Waiting for offers',
    'Confirmée': 'Confirmed',
    'Chauffeur en route': 'Driver on the way',
    'Chauffeur arrivé': 'Driver arrived',
    ...
    'Continuer avec le téléphone': 'Continue with phone',
    'Connexion Google impossible. Vérifiez la configuration Firebase et réessayez.': 'Google sign-in failed. Check Firebase configuration and try again.',
    'Connexion par téléphone': 'Phone sign-in',
    ...
    'Valider': 'Confirm',
    'Connexion par téléphone impossible. Vérifiez le numéro ou le code SMS.': 'Phone sign-in failed. Check the number or SMS code.',
