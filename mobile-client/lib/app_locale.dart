...
class AppLocale {
  ...
  static const Map<String, String> _en = {
    ...
    'Prochaine réservation': 'Next booking',
    'Voir tout': 'See all',
    'Aucune réservation à venir. Votre prochain trajet apparaîtra ici.': 'No upcoming booking. Your next trip will appear here.',
    'Mon compte': 'My account',
    'Client Veyra': 'Veyra customer',
    ...
    'Départ non renseigné': 'Pickup not set',
    'Destination non renseignée': 'Destination not set',
    'Date non choisie': 'Date not chosen',
    'Catégorie non choisie': 'Category not chosen',
    ...
    'Annuler cette réservation ?': 'Cancel this booking?',
    'Des frais peuvent s’appliquer selon le délai avant le départ. Cette action est irréversible.': 'Fees may apply depending on how close this is to departure. This action cannot be undone.',
    'Garder la réservation': 'Keep the booking',
    ...
    'Calcul des frais…': 'Calculating fees…',
    'Impossible de calculer les frais pour le moment. Vous pouvez réessayer.': 'Could not calculate fees right now. You can try again.',
    'L’annulation est gratuite.': 'Cancellation is free.',
    'Frais d’annulation': 'Cancellation fee',
    'Des frais d’annulation s’appliquent.': 'A cancellation fee applies.',
    ...
    'Chauffeur chez vous': 'Driver to pickup',
    'Jusqu’à destination': 'To destination',
    'Arrivé': 'Arrived',
    ...
    'Voir les offres reçues': 'View received offers',
    'Voir la réservation': 'View booking',
    'Réservation Veyra': 'Veyra booking',
    'Offre de ': 'Offer from ',
    'Nouvelle proposition : ': 'New offer: ',
    'Un chauffeur a envoyé une nouvelle offre pour cette réservation.': 'A driver sent a new offer for this booking.',
    'Votre chauffeur est en route vers le point de prise en charge.': 'Your driver is on the way to the pickup point.',
    'Votre chauffeur est arrivé au point de prise en charge.': 'Your driver has arrived at the pickup point.',
    'Votre course a démarré.': 'Your trip has started.',
    'Votre course est terminée.': 'Your trip is complete.',
    'Le chauffeur a annulé. Votre réservation a été remise à jour.': 'The driver cancelled. Your booking has been updated.',
    'Cette réservation a été annulée.': 'This booking was cancelled.',
    'Aucune offre chauffeur n’a été reçue pour cette demande.': 'No driver offer was received for this request.',
    'La période de recherche de chauffeur est terminée.': 'The driver search period has ended.',
    'Le statut de votre réservation a été mis à jour.': 'Your booking status has been updated.',
