...
class VeyraColors {
  ...
  // Semantic
  // success/warning ont été assombris par rapport à leur teinte
  // "naturelle" (#16A34A/#F59E0B) : ces valeurs originales, combinées au
  // texte blanc de VeyraStatusBadge (seul usage réel de ces couleurs,
  // vérifié -- aucun autre endroit du code ne les utilise), donnaient un
  // contraste de seulement 3.30:1 et 2.15:1 respectivement -- échec net
  // du seuil WCAG AA (4.5:1) pour un texte de 12px, y compris gras (ne
  // remplit pas la définition "grand texte" qui exige 14pt/18.66px).
  // Recalculé pour atteindre >=4.5:1 tout en restant visuellement
  // reconnaissable comme vert/ambre.
